...
contract('StarNotary', (accs) => {
    ...
    it('can add the star name and star symbol properly', async () => {
        ...
        let metadata = name + ' ' + symbol;
        assert.equal(metadata, 'CryptoStar Token CST');
    });
    ...
    it('lets 2 users exchange stars', async () => {
        ...
        let newOwner = await instance.ownerOf.call(starId1);
    ...
    it('lookUptokenIdToStarInfo test', async () => {
        ...
        let user1 = accounts[0];
        let starId = 10;
        await instance.createStar('udacity star', starId, { from: user1 });
        let name = await instance.lookUptokenIdToStarInfo.call(starId);
        assert.equal(name, 'udacity star');
    });
